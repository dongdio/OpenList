...
func (RarDecoder) AcceptedMultipartExtensions() map[string]tool2.MultipartExtension {
...
func (RarDecoder) GetMeta(ss []*stream.SeekableStream, args model.ArchiveArgs) (model.ArchiveMeta, error) {
	...
	_, tree := tool2.GenerateMetaTreeFromFolderTraversal(l)
...
var _ tool2.Tool = (*RarDecoder)(nil)

func init() {
	tool2.RegisterTool(RarDecoder{})
}