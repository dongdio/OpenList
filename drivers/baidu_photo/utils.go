...
func (d *BaiduPhoto) Request(client *resty.Client, furl string, method string, callback base.ReqCallback, resp any) (*resty.Response, error) {
	...
	case 0:
		break
	case 50805:
		return nil, errs.Errorf("you have joined album")
	case 50820:
		return nil, errs.Errorf("no shared albums found")
	case 50100:
		return nil, errs.Errorf("illegal title, only supports 50 characters")
	// case -6:
	// 	if err = d.refreshToken(); err != nil {
	// 		return nil, err
	// 	}
	default:
		return nil, errs.Errorf("errno: %d, refer to https://photo.baidu.com/union/doc", erron)
	}
	return res, nil
}
...
func (d *BaiduPhoto) linkAlbum(ctx context.Context, file *AlbumFile, args model.LinkArgs) (*model.Link, error) {
	...
	if resp.StatusCode() != 302 {
		return nil, errs.Errorf("not found 302 redirect")
	}
