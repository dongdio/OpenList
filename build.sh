...
ldflags="\
-w -s \
-X 'github.com/dongdio/OpenList/v4/internal/conf.BuiltAt=$builtAt' \
-X 'github.com/dongdio/OpenList/v4/internal/conf.GitAuthor=$gitAuthor' \
-X 'github.com/dongdio/OpenList/v4/internal/conf.GitCommit=$gitCommit' \
-X 'github.com/dongdio/OpenList/v4/internal/conf.Version=$version' \
-X 'github.com/dongdio/OpenList/v4/internal/conf.WebVersion=$webVersion' \
"
