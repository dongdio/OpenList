...
type Protocol interface {
	AddURI(uris []string, options ...any) (gid string, err error)
	AddTorrent(filename string, options ...any) (gid string, err error)
	AddMetalink(filename string, options ...any) (gids []string, err error)
	Remove(gid string) (result string, err error)
	ForceRemove(gid string) (result string, err error)
	Pause(gid string) (result string, err error)
	PauseAll() (ok string, err error)
	ForcePause(gid string) (result string, err error)
	ForcePauseAll() (ok string, err error)
	Unpause(gid string) (result string, err error)
	...
	ChangePosition(gid string, pos int, how string) (position int, err error)
	ChangeURI(gid string, fileindex int, delUris []string, addUris []string, position ...int) (changes []int, err error)
	GetOption(gid string) (options Option, err error)
	ChangeOption(gid string, option Option) (ok string, err error)
	GetGlobalOption() (options Option, err error)
	...
	Multicall(methods []Method) (results []any, err error)
